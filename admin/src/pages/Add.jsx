...
const AddProduct = ({ token }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      <h2 className="text-2xl font-bold text-center mb-6 border-b-2 border-cyan-500 text-white bg-gray-600">
        Add New Product
      </h2>
      ...
      >
            ...
            <div className="flex flex-wrap gap-4">
              {["S", "M", "L", "XL", "XXL"].map((size) => (
                <button
                  ...
                  type="button"
                  className={`px-4 py-2 border-2 rounded-lg transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${
                    sizes.includes(size)
        ...
        <div className="flex justify-center">
          <button
            type="submit"
            className="px-8 py-3 bg-gray-500 text-white rounded-lg font-semibold hover:bg-cyan-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
            disabled={loading}
          >
            {loading ? (
