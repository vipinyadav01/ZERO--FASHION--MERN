    ...
    <div className="border-t-2  transition-opacity ease-in duration-500 opacity-100 mt-24">
      <div className="flex gap-12 sm:gap-12 flex-col sm:flex-row">
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-1 mt-2">
            ...
            <p className="pl-2">(199)</p>
          </div>
          <p className="mt-5 text-3xl font-sans">
            {currency}
            {productData.price}
          </p>
      ...
      <div className="mt-20">
        ...
        <div className="flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500">
          <p>
            An e-commerce website is a virtual store where customers can buy and
            sell products and services online
          </p>
          <p>
            An e-commerce website allows customers to browse products, place
            orders, and make payments. It also allows businesses to process
            orders, manage shipping, and provide customer service
          </p>
        </div>
      </div>
