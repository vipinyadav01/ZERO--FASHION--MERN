...
const SearchBar = () => {
  ...
  useEffect(() => {
    setVisible(location.pathname.includes("collection") || location.pathname === "/");
  }, [location]);
  ...
  return (
    <>
      ...
      {/* Search Bar */}
      <div
        className={`fixed top-0 left-0 right-0 z-40 bg-white md:bg-gray-50 transform transition-transform duration-200 ease-in-out search-bar ${
