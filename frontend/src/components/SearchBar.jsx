...
const SearchBar = () => {
    ...
    return (
        <>
            ...
            <div
                className={`fixed top-0 left-0 right-0 z-40 bg-white md:bg-gray-50 transform transition-transform duration-200 ease-in-out search-bar ${showSearch ? "translate-y-0" : "-translate-y-full"
                    }`}
            >
                <div className="border-b shadow-md">
                    <div className="flex items-center justify-between px-4 py-2 border-b md:hidden"></div>
