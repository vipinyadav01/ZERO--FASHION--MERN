                                    ...
                                    >
                                        <div className="py-2">
                                            <div className="px-4 py-2 border-b border-gray-200">
                                                <p className="text-sm font-medium text-gray-900">Your Cart ({getCartCount()} items)</p>
                                            </div>
                                            {/* Add cart items here */}
                                            <Link
                                                to="/cart"
                    ...
                    >
                        ...
                        <div className="flex flex-col h-full p-6">
                            ...
                            <div className="flex justify-between items-center mb-8">
                                <Link to="/" className="flex items-center space-x-3" onClick={() => setVisible(false)}>
                                ...
                                {navLinks.map(({ path, label }) => (
                                    ...
                                    >
                                        <NavLink
                                            to={path}
                                            className={({ isActive }) =>
                                                `text-xl font-medium ${isActive ? "text-indigo-600" : "text-gray-800 hover:text-indigo-600"
